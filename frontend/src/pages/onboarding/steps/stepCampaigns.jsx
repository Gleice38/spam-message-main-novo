...
const styles = {
  ...
  visualSide: { width: '42%', minWidth: 0, background: 'linear-gradient(135deg, #a855f7 0%, #7c3aed 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' },
