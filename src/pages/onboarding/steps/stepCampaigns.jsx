...
export default function StepCampaigns({ onNext, onPrev, onSkip }) {
  return (
    <div style={styles.wrapper}>
      <div style={styles.container}>
        
        {/* LADO ESQUERDO: VISUAL ROXO/MAGENTA */}
        <div style={styles.visualSide}>
          ...
          <div style={styles.iconCard}>
            <div style={styles.iconCircle}>
              <Send size={42} color="#ffffff" style={{ transform: 'rotate(-10deg)' }} />
            </div>
          </div>
          
          <div style={styles.stepBadge}>Passo 4 de 7</div>
          
          <div style={styles.dotsRow}>
            {[...Array(7)].map((_, i) => (
              <div key={i} style={i === 3 ? styles.activeDot : styles.dot}></div>
            ))}
          </div>
        </div>
        ...
        <div style={styles.contentSide}>
          ...
          <div style={styles.body}>
            <h1 style={styles.title}>Crie Campanhas Personalizadas</h1>
            <h2 style={styles.subtitle}>Envio individual para cada contato</h2>
            
            <p style={styles.descriptionText}>
              Crie campanhas de WhatsApp com mensagens personalizadas. Todas as mensagens são 
              enviadas individualmente, não para grupos, garantindo comunicação profissional.
            </p>
          </div>

          <div style={styles.footer}>
            {/* Botão Pular alinhado à esquerda no rodapé interno */}
      ...
      {/* Frase externa centralizada abaixo do card */}
...
const styles = {
  ...
  visualSide: { width: '42%', background: 'linear-gradient(135deg, #a855f7 0%, #7c3aed 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' },
