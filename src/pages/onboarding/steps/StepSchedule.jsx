...
export default function StepSchedule({ onNext, onPrev, onSkip }) {
  return (
    <div style={styles.wrapper}>
      <div style={styles.container}>
        
        {/* LADO ESQUERDO: VISUAL ROXO/VIBRANTE */}
        <div style={styles.visualSide}>
          ...
          <div style={styles.iconCard}>
            <div style={styles.iconCircle}>
              {/* Ícone de Calendário para Agendamento */}
              <Calendar size={42} color="#ffffff" />
            </div>
          </div>
          
          <div style={styles.stepBadge}>Passo 5 de 7</div>
          
          <div style={styles.dotsRow}>
            {[...Array(7)].map((_, i) => (
              <div key={i} style={i === 4 ? styles.activeDot : styles.dot}></div>
            ))}
          </div>
        </div>
        ...
        <div style={styles.contentSide}>
          ...
          <div style={styles.body}>
            <h1 style={styles.title}>Agende e Controle</h1>
            <h2 style={styles.subtitle}>Configure horários e intervalos de envio</h2>
            
            <p style={styles.descriptionText}>
              Defina horários permitidos para envio e intervalos entre mensagens. 
              Respeite o tempo dos seus contatos e evite bloqueios do WhatsApp.
            </p>
          </div>

          <div style={styles.footer}>
            {/* Alinhamento do botão Pular Tutorial conforme o padrão visual */}
      ...
      {/* Frase externa centralizada conforme o protótipo */}
...
const styles = {
  ...
  visualSide: { width: '42%', background: 'linear-gradient(135deg, #9333ea 0%, #7c3aed 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' },
