      ...
      <div style={styles.container}>
        ...
        <div style={styles.contentSide}>
          ...
          <div style={styles.footer}>   
            {/* Espaçador para manter os botões de navegação à direita */}
            <div /> 
            ...
            <div style={styles.navButtons}>
              ...
              <button onClick={onFinish} style={styles.btnFinish}>
...
const styles = {
  ...
  visualSide: { width: '42%', background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' },
