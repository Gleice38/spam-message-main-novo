...
export default function StepAnalytics({ onNext, onPrev, onSkip }) {
  return (
    <div style={styles.wrapper}>
      <div style={styles.container}>
        
        {/* LADO ESQUERDO: VISUAL MAGENTA */}
        <div style={styles.visualSide}>
          ...
          <div style={styles.iconCard}>
            <div style={styles.iconCircle}>
              {/* Ícone de tendência conforme imagem 6 */}
              <TrendingUp size={42} color="#ffffff" />
            </div>
          </div>
          
          <div style={styles.stepBadge}>Passo 6 de 7</div>
        ...
        <div style={styles.contentSide}>
          ...
          <div style={styles.body}>
            <h1 style={styles.title}>Acompanhe Resultados</h1>
            <h2 style={styles.subtitle}>Dashboard com estatísticas completas</h2>
            
            <p style={styles.descriptionText}>
              Visualize métricas importantes: total de contatos, mensagens enviadas, 
              campanhas ativas e distribuição por região. Tome decisões baseadas em dados.
            </p>
          </div>

          <div style={styles.footer}>
            {/* Botão alinhado à esquerda conforme o design */}
            <button onClick={onSkip} style={styles.btnSkip}>Pular Tutorial</button>
...
const styles = {
  ...
  visualSide: { width: '42%', background: 'linear-gradient(135deg, #c026d3 0%, #a21caf 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' },
